<template>
    <Navbar />
    <div class="flex items-center justify-end p-36">
        <div class="content flex-grow d-flex flex-column align-items-center justify-content-center">
            <div>
                <h1>La guía definitiva</h1>
            </div>
            <p>Touch typing is all about the idea that each finger has its own area on the keyboard. Thanks to that fact
                you can type without looking at the keys. Practice regularly and your fingers will learn their location
            ...
            <div class="lista d-flex flex-column align-items-center">
                <ul>
                    ...
                    <li>Expose the shoulder, arm, and wrist muscles to the least possible strain. The wrists can touch
                        the tabletop in front of the keyboard. Never shift your body weight to the wrists by resting on
                        them.</li>
                </ul>
            </div>
